...
import sys
# from maze.obstacles import obstacles_list
...
def get_robot_name():
    """
    getting the robot name from the user.
    -if the user presses 'enter' without entering anything,
    it will keep asking for the name.
    """
...
def robot_start():
    ...
    global history, obstacles_list
    robot_name = get_robot_name()
    output(robot_name, "Hello kiddo!")
    if 'turtle' in sys.argv:
        output(robot_name,"Loaded the_worlds_most_crazy_maze.")
    else:
        output(robot_name,"Loaded obstacles.")

    world.obstacles.obstacles_list = world.obstacles.get_obstacles()
    
    world.reset_position()
    history = []

    obstacles_list = world.obstacles.obstacles_list
    world.obstacle_location(obstacles_list)
