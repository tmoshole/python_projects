...
def obstacle_location(obstacles_list):
    ...
    for i in range(len(obstacles_list)):
        ...
        tshepo.pendown()
        tshepo.goto(obstacles_list[i][0]+4,obstacles_list[i][1])
        tshepo.goto(obstacles_list[i][0]+4,obstacles_list[i][1]+4)
        tshepo.goto(obstacles_list[i][0],obstacles_list[i][1]+4)
        tshepo.goto(obstacles_list[i][0],obstacles_list[i][1])
    tshepo.penup()
    tshepo.home()
    tshepo.color("black")
